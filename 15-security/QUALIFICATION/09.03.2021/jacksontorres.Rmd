...
```{r setup, include=FALSE, echo=FALSE, message=FALSE, preview = TRUE}
...
require(DiagrammeRsvg); require(webshot); require(rmarkdown); library(ipeadatar)
#library(Hmisc); library(conflicted)

#library(BatchGetSymbols)
#library(Quandl); library(BETS); library(GetTDData); library(Rbitcoin)
```

```{r source.datas, message=FALSE, include=FALSE, eval=TRUE}
...
```{r table spreads, echo=FALSE, eval=FALSE, include=FALSE}
...
```{r datamodel, eval=FALSE, include=FALSE}
