...
$SprEp_{it}$: O *Spread Ex-post* ($SprEp$), será calculado a partir dos resultados contábeis, resultante da diferença entre da relação de receitas de operações de crédito ($RcOpCr$) e operações de crédito médio ($OpCrMe$), e a relação de despesas de captação ($DesCap$) e depósitos médio ($Dep$)
$$
...
$H_1$: A proporção das operações de crédito com capital próprio ($EPr$) em relação as receitas de operação de crédito ($R$) guarda relação direta com o *spread ex-post* ($SprEp$) e direta com a rentabilidade bancária ($Rent$).

$$
Epr = \frac{E_{prit}}{R_{it}}
$$

$H_2$: A proporção das operações de crédito com depósitos à vista ($OpCrDpAv$) mantém uma relação direta com *spread ex-post* ($SprEp$) e direta com a rentabilidade bancária ($Rent$).

$H_3$: A proporção das operações de crédito com depósitos à prazo ($OpCrDpAp$) atuam na inversa do *spread ex-post* ($SprEp$) e inversa com a rentabilidade bancária ($Rent$) do período.

$H_4$: O multiplicador de aplicação bancária ($i_{apl}$) possui relação direta com o *spread ex-post* ($SprEp$) e mantendo-se constantes os demais elementos além da margem de lucro líquido ($I_{ll}$), possui relação direta com a rentabilidade bancária ($Rent$).

$$
MApl = i_{apl} = \frac{1}{1 -  \frac{i_{ll}}{1 - i_{ir}  - i_{cs}} + i_{pis} + i_{cof}}
$$

$H_5$: A relação do juros de capital  próprio com a receita das operações de crédito ($Jcp$) guarda relação inversa com *spread ex-post* ($SprEp$) e direta com a rentabilidade bancária ($Rent$).

$$
Jcp = i_{jcp} = \frac{Jcp}{R}
$$

$H_6$: O ativo total ($lnAtv$) mantém uma relação inversa com *spread ex-post* ($SprEp$) e nula com a rentabilidade bancária ($Rent$)
...
$H_8$: o grau de concentração de mercado mantém relação direta com *spread ex-post* ($SprEp$) e nula com a rentabilidade bancária ($Rent$)
...
$H_10$: A origem de controle de capital $OrCap$ excerce influência
 do nível *spread ex-post* ($SprEp$) e na determinação no nível de rentabilidade bancária ($Rent$)
...
$H_12$: A taxa Selic $Sel$ mantém uma relação direta  no *spread ex-post* ($SprEp$) e nula com a rentabilidade bancária ($Rent$)
