...
Em fase preliminar foram testados os modelos de regressão SUR: *pooling*, efeitos aleatórios e efeitos fixos, conforme \autoref{apendicec}, remontando coeficientes de determinação ($R^2$) na faixa de 0,85, Porém na etapa de testes as modelagens apresentaram problemas de heterocedasticidade e correlação serial, prejudicando a confiabilidade das estimações. 
