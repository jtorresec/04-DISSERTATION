...
## ----bank.evolution, message=FALSE, fig.width= 6, fig.height=3----------------
ev.banks <- 
        em.banks %>% 
...
## ----concetration, fig.width=5, fig.height=3----------------------------------
con.banks <- 
        em.banks %>%
        transform(Ano = as.integer(Ano)) %>% 
        filter(Mês == 'Dez') %>%
...
## ----capital.graphic, fig.width=5, fig.height=3-------------------------------
ev.o.banks <- 
        o.banks %>% 
...
## ----credit.gdp, fig.width=5, fig.height=3------------------------------------
...
## ----balance.credit, fig.width=5, fig.height=2.5------------------------------
...
## ----money.base.d, fig.width=5, fig.height=3----------------------------------
...
## ----m2m3m4, fig.width=5, fig.height=3----------------------------------------
