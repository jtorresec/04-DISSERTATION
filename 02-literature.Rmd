...
Nesse capítulo serão abordados os conceitos, características, composição e evolução do setor bancário brasileiro com objetivo de identificar variáveis quantitativas e qualitativas relevantes para as analises dos componentes do *spread* bancário. 

O setor bancário brasileiro é componente do Sistema Financeiro Nacional — SFN, sob hierarquia normativa do Conselho Monetário Nacional - CMN e supervisão do Banco Central do Brasil — BACEN. As instituições que formam o setor bancário assumem o papel de operadoras no mercado de crédito, atuando como intermediadoras financeiras junto as pessoas físicas e jurídicas, podendo ser de caráter público ou privado \cite{Lei:4595:1964}.

```{r instituicoes financeiras, echo=FALSE, message=FALSE, fig.align='center', fig.height=3, fig.width=3}
...
```{r resume banks, echo=FALSE, message=FALSE, fig.align='center', results='asis'}
table.banks <- 
        em.banks %>% 
...
```{r bank evolution, echo=FALSE, message=FALSE, results='asis', fig.align='center', fig.height=3, fig.width=5}
ev.banks <- 
        em.banks %>% 
...
```{r banks origin, echo=FALSE, message=FALSE, fig.align='center', results='hide'}
...
```{r table origin, echo=FALSE, fig.align='center', message=FALSE, fig.height=3, fig.width=3}
o.banks.2019 <- 
        o.banks %>%
...
```{r concetration, echo=FALSE, message=FALSE, fig.height=3, fig.width=5, fig.align='center'}
con.banks <- 
        em.banks %>%
        transform(Ano = as.integer(Ano)) %>% 
        filter(Mês == 'Dez') %>%
...
```{r capital banks, echo=FALSE, message=FALSE, fig.align='center'}
c.banks <- 
        o.banks %>% 
        filter(Ano == '2019') %>% 
...
```{r capital graphic, echo=FALSE, message=FALSE, fig.align='center', fig.height=3, fig.width=5}
ev.o.banks <- 
        o.banks %>% 
...
```{r credit gdp, echo=FALSE, message=FALSE, fig.align='center', fig.height=3, fig.width=5}
...
```{r average spread, echo=FALSE, message=FALSE, fig.align='center', fig.height=3, fig.width=5, warning=FALSE}
...
```{r spread 2019, echo=FALSE, message=FALSE, fig.align='center', fig.height=3, fig.width=5}
...
```{r studies, echo=FALSE, message=FALSE, fig.align='center'}
studies <- 
